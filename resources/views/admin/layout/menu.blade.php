...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ url('/dbo') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder text-capitalize ms-2">Allia Store</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- Batasi pages dashboard & user management hanya untuk manager --}}
        @if ($role == 'manager')
            <!-- Dashboard -->
            <li class="menu-item @if (Request::url() == route('admin.dashboard')) active @endif">
                <a href="{{ url('/dbo') }}" class="menu-link">
