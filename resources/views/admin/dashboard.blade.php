@extends('admin.layout.appadmin', ['title' => 'Dashboard'])
@section('content')
    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            @php
                                function formatCurrency($amount) {
                                  if ($amount >= 1e9) {
                                      return number_format($amount / 1e9, 2, ',', '.') . ' Mlyr';
                                  } elseif ($amount >= 1e6) {
                                      return number_format($amount / 1e6, 2, ',', '.') . ' Jt';
                                  } elseif ($amount >= 1000) {
                                      return number_format($amount / 1000, 2, ',', '.') . ' Rb';
                                  } else {
                                      return number_format($amount, 0, ',', '.');
                                  }
                              }
                            @endphp
                            <h3 class="card-title text-nowrap mb-1">{{ formatCurrency($total_sales) }}</h3>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="d-flex flex-column align-items-center gap-1">
                            <h2 class="mb-2">{{ number_format(count($orders), 0, ',', '.') }}</h2>
