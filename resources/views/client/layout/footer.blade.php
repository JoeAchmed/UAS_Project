                      ...
                      <div class="follow_us">
                          ...
                          <ul>
                              <li><a href="#0"><img
                                          ...
                                          data-src="{{ asset('client/img/twitter_icon.svg') }}" alt=""
                                          class="lazy"></a></li>
                              <li><a href="#0"><img
                                          src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                          data-src="{{ asset('client/img/facebook_icon.svg') }}" alt=""
                                          class="lazy"></a></li>
                              <li><a href="#0"><img
                                          src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                          data-src="{{ asset('client/img/instagram_icon.svg') }}" alt=""
                                          class="lazy"></a></li>
                              <li><a href="#0"><img
                                          src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                          data-src="{{ asset('client/img/youtube_icon.svg') }}" alt=""
                                          class="lazy"></a></li>
                          </ul>
                      </div>
                  </div>
              ...
              <div class="col-lg-6">
                  <ul class="footer-selector clearfix">
                      ...
                      <li><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              data-src="{{ asset('client/img/cards_all.svg') }}" alt="" width="198"
