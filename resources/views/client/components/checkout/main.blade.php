                ...
                <div class="tab-content checkout">
                    ...
                    <div class="tab-pane fade" id="tab_2" role="tabpanel" aria-labelledby="tab_2"
                        ...
                        <div class="clearfix add_bottom_15">
                            ...
                            <div class="float-end">
                                <a id="forgot" href="#0">Lost Password?</a>
                            </div>
                        </div>
                        <div id="forgot_pw">
                            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="step last">
                ...
                <div class="box_general summary">
                    <ul>
                        <li class="clearfix">
                            <em>1x Armor Air X Fear</em>
                            <span>$145.00</span>
                        </li>
                        <li class="clearfix">
                            <em>2x Armor Air Zoom Alpha</em>
                            <span>$115.00</span>
                        </li>
                    </ul>
                    <ul>
                    ...
                    <a href="{{ url('checkout?status=success') }}" class="btn_1 full-width">Confirm and Pay</a>
                </div>
                <!-- /box_general -->
            </div>
            <!-- /step -->
